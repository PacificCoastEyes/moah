...
const Hero = () => {
  ...
  useEffect(() => {
    if (Object.values(heroImageLoadStatus).every(loadStatus => loadStatus)) {
    ...
    <Box id="hero" maxWidth={{ xs: "initial", md: "60%" }} marginY="auto">
      ...
      >
        ...
        <Grid item xs={12} md={6} display="flex" justifyContent="center">
          <img
            src="https://moahappstorage.blob.core.windows.net/assets/images/hero/desert-sunset.jpg"
            onLoad={() => handleOnLoad("desertSunset")}
            style={
              displayHeroImages ? { display: "block" } : { display: "none" }
            }
            alt="Desert sunset"
          />
          {!displayHeroImages && (
        ...
        >
          <Grid item xs={12} md={6} alignSelf="center">
            <Typography id="hero-the" variant="h2" textAlign="center">
              the
            </Typography>
          </Grid>
          <Grid item display="flex" xs={12} md={6} justifyContent="center">
            <img
              src="https://moahappstorage.blob.core.windows.net/assets/images/hero/forest.jpg"
        ...
        <Grid item xs={12} md={6} display="flex" justifyContent="center">
          <img
            src="https://moahappstorage.blob.core.windows.net/assets/images/hero/water-ripple.jpg"
